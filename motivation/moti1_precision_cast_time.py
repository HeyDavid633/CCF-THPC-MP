...
#
# 对应于moti1_diff_precision_time.py  但这边统计fp16+cast的时间
#
...
if __name__ == '__main__':
    ...
    if sys.argv[1] == 'FP32':
        ...
        data_type_reverse = torch.float16
    else:
        data_type = torch.float16
        data_type_reverse = torch.float32
    ...
    now = datetime.now().strftime('cast_%b_%d_%H_%M')
