...
# 
# emp    python train_cv_emp_mainbody.py -net alexnet -epoch 1 -precision emp 
import csv
import argparse
import timeit
import torch
...
if __name__ == '__main__':
    ...
    if args.net == 'alexnet':    
        ...
        model_layer_num = 51
        policy_precision_string = '0'*model_layer_num
        adjustable_id_list = [0, 1, 4, 8, 11, 50]
        from models.vgg import vgg16_bn_emp, vgg16_bn
    ...
    if args.net == 'alexnet':
        ...
        net = vgg16_bn_emp(policy_precision_string = stage2_policy_selected) 
    ...
    if len(strings_for_stage2) > 1:
        for stage2_policy_precision_string in strings_for_stage2[1:]:
            ...
            if args.net == 'alexnet':
                ...
                net = vgg16_bn_emp(policy_precision_string = stage2_policy_precision_string) 
