...
def train(epoch):
    ...
    append_to_csv(epoch, running_loss / len(cifar100_training_loader), 'amp_epoch_loss.csv')    
...
if __name__ == '__main__':
    ...
    # 记录csv文件，给出标题
    append_to_csv('Epoch', 'AMP_loss', 'amp_epoch_loss.csv') 
    ...
    print('{} with {} epoch,\tAMP total training time:{:.2f} min'.format(args.net, settings.EPOCH, (train_end_time - train_start_time)/60))
